...
/**
 * Handles building the basic OpenAPI specification structure
 */
export class SpecBuilder {
  /**
   * Create initial OpenAPI spec with basic information and security
   */
  public createSpec(): OpenAPISpec {
